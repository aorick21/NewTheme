...
<?php
	/* Start the Loop.
	 *
	 * In robot we use the same loop in multiple contexts.
...
<?php /* How to display all other posts. */ ?>
	<?php elseif ( is_single() ) : ?>
			<article>
				...
				<section class="news-post"><h2><a class="" href="<?php the_permalink() ?>"><?php the_title(); ?></a></h2>
				<div class="entry-meta"><span><?php the_time(get_option('date_format')); ?></span></div>
				<div><?php the_content(); ?></div></section>
	<!--			<div><?php the_excerpt(__('(Read more…)')); ?></div></section> -->
...
<?php if (  $wp_query->max_num_pages > 1 ) : ?>
				<div id="nav-below" class="navigation">
					<div class="nav-previous"><?php next_posts_link( __( '<div class="button">Load More Posts</div>', 'smpl' ) ); ?></div>
<!--					<div class="nav-next"><?php previous_posts_link( __( '<div class="button">Newer posts</div>', 'smpl' ) ); ?></div> -->
				</div><!-- #nav-below -->
<?php endif; ?>
